...
DATAFILE 'backup/u02/oradata/SDETEST/SDETEST_system01.dbf' SIZE 200M
logfile group 1 ('/backup/u03/oradata/SDETEST/SDETEST_redo01_a.log',
                 '/home/u01/app/oradata/SDETEST/SDETEST_redo01_b.log') size 10M,
group 2 ('/backup/u03/oradata/SDETEST/SDETEST_redo02_a.log',
                 '/home/u01/app/oradata/SDETEST/SDETEST_redo02_b.log') size 10M,
group 3 ('/backup/u03/oradata/SDETEST/SDETEST_redo03_a.log',
...
CREATE TABLESPACE RBS DATAFILE '/backup/u04/oradata/SDETEST/SDETEST_rbs01.dbf' SIZE 500M 
DEFAULT STORAGE ( INITIAL 1M NEXT 1M  MINEXTENTS 20 MAXEXTENTS 1024 PCTINCREASE 0);

REM ************** TABLESPACE FOR TEMPORARY *****************
CREATE TABLESPACE TEMP DATAFILE '/backup/u05/oradata/SDETEST/SDETEST_temp01.dbf' SIZE 300M 
DEFAULT STORAGE ( INITIAL 2M NEXT 2M MINEXTENTS 1 MAXEXTENTS UNLIMITED PCTINCREASE 0) TEMPORARY;

create tablespace USERS datafile '/backup/u06/oradata/SDETEST/SDETEST_ts_users.dbf'
size 70M default storage (pctincrease 0);

create tablespace TOOLS datafile '/backup/u06/oradata/SDETEST/SDETEST_ts_tools.dbf'
size 70M default storage (pctincrease 0);

create tablespace TS_DATA datafile '/backup/u06/oradata/SDETEST/SDETEST_ts_data_1.dbf'
size 500M minimum extent 1M default storage (initial 1M next 1M maxextents 1024 pctincrease 0);

alter tablespace TS_DATA add datafile '/backup/u06/oradata/SDETEST/SDETEST_ts_data_2.dbf' size 500M;

create tablespace TS_INDEXES datafile '/backup/u07/oradata/SDETEST/SDETEST_ts_indexes_1.dbf'
