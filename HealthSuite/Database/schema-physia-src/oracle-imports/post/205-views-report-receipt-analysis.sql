...
group by t.provider_id,iia.pay_date,short_sortable_name,decode(iia.payer_type,0,'Personal Receipts', 'Insurance Receipts'),decode(iia.payer_type,0,pm.caption,'PAYMENT'),ins.plan_name
