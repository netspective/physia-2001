...
sub getForm
{
	...
	return ('Lookup HCPCS code/description', qq{
		<CENTER>
		<NOBR>
...
sub execute
{
	...
	$self->addContent(
		'<CENTER>',
		$STMTMGR_HCPCS_CODE_SEARCH->createHtml($self, STMTMGRFLAG_NONE, "sel_hcpcs_$type$appendStmtName", $bindParams,
#			[
