##############################################################################
package App::Page::Search::Modifier;
##############################################################################
...
sub getForm
{
	...
	return ('Lookup Modifier code/name', qq{
		<CENTER>
		<NOBR>
...
sub execute
{
	...
	$self->addContent(
		'<CENTER>',
		$STMTMGR_MODIFIER_CODE_SEARCH->createHtml($self, STMTMGRFLAG_NONE, "sel_modifier_$type$appendStmtName", $bindParams,
#			[
