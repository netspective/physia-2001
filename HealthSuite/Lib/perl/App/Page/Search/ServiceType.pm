##############################################################################
package App::Page::Search::ServiceType;
##############################################################################
...
sub getForm
{
	...
	return ('Lookup Service Type code/name', qq{
		<CENTER>
		<NOBR>
...
sub execute
{
	...
	$self->addContent(
		'<CENTER>',
		$STMTMGR_SERVICETYPE_CODE_SEARCH->createHtml($self, STMTMGRFLAG_NONE, "sel_type_$type$appendStmtName", $bindParams,
#			[
