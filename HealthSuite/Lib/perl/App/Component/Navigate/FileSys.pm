...
use enum qw(BITMASK:NAVGFILEFLAG_ PERLOBJECT RAWTEXT HTML XML PASSTHROUGH TRANSLATEUNDL TRANSLATEDATES ORGLOCKDOWN EXCEL);
use vars qw(@ISA @EXPORT %MODULE_FILE_MAP %FILE_MODULE_MAP %FILE_TYPE_MAP %RESOURCE_MAP);
@ISA   = qw(Exporter CGI::Component);
@EXPORT = qw(NAVGPATHFLAG_STAYATROOT NAVGFILEFLAG_PERLOBJECT NAVGFILEFLAG_RAWTEXT NAVGFILEFLAG_HTML NAVGFILEFLAG_XML NAVGFILEFLAG_EXCEL);
...
%FILE_TYPE_MAP = (
	...
	'.nsf' => [NAVGFILEFLAG_RAWTEXT | FILEFLAGS_DEFAULT, ICONGRAPHIC_PAGE, ICONGRAPHIC_SELARROW],
	'.csv' => [NAVGFILEFLAG_EXCEL | FILEFLAGS_DEFAULT, ICONGRAPHIC_PAGE, ICONGRAPHIC_SELARROW],
