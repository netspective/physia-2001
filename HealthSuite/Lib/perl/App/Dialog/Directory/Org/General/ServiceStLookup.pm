##############################################################################
package App::Dialog::Directory::Org::General::ServiceStLookup;
##############################################################################
...
sub new
{
	my $self = App::Dialog::Directory::new(@_, id => 'provider-service-state', heading => 'Service + State');
