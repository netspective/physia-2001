##############################################################################
package App::Dialog::InvoiceWorklist::ReferralPPMS::CloseReferral;
##############################################################################
...
#			data => "Invoice <a href='/invoice/#param.referral_id#/summary/'>#param.invoice_id#</a> closed on referral <a href='/person/#session.person_id#/profile'>#session.person_id#</a> worklist"
#		};
...
sub execute
{
	...
	my $close_msg = "Referral Closed by $closed_by";
	my $first =1;
	#
