...
sub initialize
{
	...
	$self->addContent(
		new App::Dialog::Field::Attribute::Name(
			type => 'select',
			selOptions => 'DEA;DPS;Medicaid;Medicare;UPIN;Tax ID;IRS;Board Certification;BCBS;Railroaad Medicare:Champus;WC#;National Provider Identification;Nursing/License',
			caption => 'License',
			name => 'value_textb',
