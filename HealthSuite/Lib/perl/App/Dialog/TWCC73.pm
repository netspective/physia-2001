...
sub new
{
	...
	$self->addContent(		
		...
		new CGI::Dialog::Field(type => 'bool', style => 'check', caption => 'Must wear splint/cast at work', name => 'wear_splint_cast'),
		new CGI::Dialog::Field(type => 'bool', style => 'check', caption => 'Must use crutches at all times', name => 'crutches'),
		new CGI::Dialog::Field(type => 'bool', style => 'check', caption => 'No driving/operating heavy equipment', name => 'no_driving'),
		new CGI::Dialog::Field(type => 'bool', style => 'check', caption => 'Can only drive automatic transmission', name => 'auto_transmission_only'),
