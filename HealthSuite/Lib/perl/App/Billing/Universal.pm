...
use constant CHAMPUS => '8';
use constant BCBS => '11';
use constant RAILROAD => '15';
use constant EPSDT => '99';
...
@EXPORT = qw(NSFDEST_ARRAY NSFDEST_FILE NSF_HALLEY NSF_ENVOY NSF_THIN
				...
				PAYERINFOIDX_NAME PAYERINFOIDX_VALIDATEFUNC GREATER LESS EQUAL NOT_EQUAL
				CONTAINS NOT_CONTAINS NOT_ALL CHECK_EXACT_VALUES CHECK_CHARACTERS
				INDIVIDUAL_NAME BCBS RAILROAD EPSDT CHAMPUS);
