...
sub formatData
{
	...
	return sprintf('%-3s%-2s%-17s%-17s%-8s%-8s%-2s%-2s%-5s%-2s%-2s%-2s%7s%1s%1s%1s%1s%4s%4s%1s%1s%1s%-15s%-15s%-2s%1s%7s%7s%1s%1s%-10s%-9s%-3s%-15s%7s%-2s%-3s%1s%1s%1s%-8s%3s%2s%3s%3s%-8s%3s%7s%7s%-81s%2s',
	$self->recordType(),
...
sub formatData
{
	...
	my $zero = "0";
	return sprintf('%-3s%-2s%-17s%-17s%9s%-1s%-17s%-10s%-1s%-3s%-3s%-15s%-18s%-15s%-2s%9s%-178s',
	$self->recordType(),
	$self->numToStr(2,0,$container->getSequenceNo()),
	substr($Patient->getAccountNo(),0,17),
	$spaces, # Line item control number
...
sub formatData
{
	...
	return sprintf('%-3s%-2s%-17s%-17s%7s%7s%7s%7s%-15s%-2s%-15s%-2s%4s%4s%-11s%7s%-15s%-8s%2s%1s%1s%1s%1s%1s%-15s%-9s%-33s%-30s%-30s%-20s%-9s%-9s%-3s%-2s%-2s',
	$self->recordType(),
	$self->numToStr(2,0,$container->getSequenceNo()),
	substr($Patient->getAccountNo(),0,17),
	$spaces,
...
sub formatData
{
	...
	return sprintf('%-3s%-2s%-17s%-17s%-33s%-20s%-12s%-1s%-15s%-20s%-12s%-1s%-15s%-20s%-12s%-1s%-15s%-20s%-12s%-1s%-15s%-15s%-20s%-21s',
	$self->recordType(),
	$self->numToStr(2,0,$container->getSequenceNo()),
	substr($Patient->getAccountNo(),0,17),
	$spaces,
...
sub formatData
{
	...
	return sprintf('%-3s%-2s%-17s%-17s%-2s%-30s%-30s%-20s%-2s%-9s%-2s%-30s%-30s%-20s%-2s%-9s%-2s%-30s%-30s%-20s%-2s%-9s%-2s',
	$self->recordType(),
	$self->numToStr(2,0,$container->getSequenceNo()),
	substr($Patient->getAccountNo(),0,17),
	$spaces,
...
sub formatData
{
	...
	return sprintf('%-3s%-2s%-17s%-17s%-9s%-15s%-2s%7s%7s%-5s%4s%-2s%-20s%-2s%-2s%-206s',
	$self->recordType(),
	$self->numToStr(2,0,$container->getSequenceNo()),
	substr($Patient->getAccountNo(),0,17),
	$spaces,
