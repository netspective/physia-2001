...
my %nsfType = (NSF_HALLEY . "" =>
	...
	NSF_THIN . "" =>
	sprintf("%-3s%-2s%-17s%-1s%-1s%-1s%-8s%-5s%-1s%-2s%-2s%-1s%-1s%-8s%-1s%-8s%-1s%-8s%-8s%-15s%-15s%-1s%-9s%-20%-12s%-1s%-2s%-8s%-8s%-1s%7s%-5s%-5s%-5s%-5s%-1s%-1s%-8s%-33s%-1s%-1s%-2s%-2s%-1s%-1s%-2s%-15s%-8s%-8s%-1s%-3s%-3s%-6s%-15s%-10s",
	$self->recordType(),
