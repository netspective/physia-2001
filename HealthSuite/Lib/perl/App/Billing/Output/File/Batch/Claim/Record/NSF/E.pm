...
sub formatData
{
	...
	return sprintf("%-3s%-2s%-17s%1s%1s%1s%-8s%-5s%1s%-2s%-2s%1s%1s%-8s%1s%-8s%1s%-8s%-8s%-15s%-24s%-1s%-20s%-10s%-2s%1s%-2s%-8s%-8s%1s%7s%-5s%-5s%-5s%-5s%1s%1s%-8s%-22s%-11s%1s%1s%-2s%-2s%1s%1s%-2s%-15s%-8s%-8s%1s%-10s%-26s%1s",
	$self->recordType(),
...
sub formatData
{
	...
	return sprintf('%-3s%-2s%-17s%-15s%-15s%-18s%-12s%-30s%-15s%-5s%-2s%-9s%-17s%-8s%-8s%-8s%-8s%-15s%-15s%-20s%-12s%1s%-2s%-20s%-12s%1s%-15s%-15s',
	$self->recordType(),
	$spaces, 
...
sub formatData
{
    ...
    my $claimpayToProviderAddress  = $claimpayToProvider->{address};
   	...
   	return sprintf("%-3s%-2s%-17s%-20s%-15s%1s%1s%-11s%1s%-2s%-2s%-25s%1s%1s%-2s%-6s%-2s%-10s%-2s%-3s%-8s%-8s%-8s%-4s%9s%1s%-17s%-3s%-10s%1s%-3s%-15s%-15s%10s%-15s%-15s%-3s%1s%-47s",
	$self->recordType(),
	$spaces,
	substr($inpClaim->{careReceiver}->getAccountNo(), 0, 17),
	$spaces,
