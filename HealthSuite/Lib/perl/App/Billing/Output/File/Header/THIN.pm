###################################################################################
package App::Billing::Output::File::Header::THIN;
###################################################################################
...
sub formatData
{
	...
	my %payerType = ( THIN_MEDICAID . "" =>
	  ...
	  $spaces, # retransmission status
	  $spaces, # origional sub id
	  $spaces, # vendor applicaion category
	  $spaces, # vendor software version
	  $spaces, # vendor software update
