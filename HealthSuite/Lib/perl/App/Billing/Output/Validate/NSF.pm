...
# Rendering Provider Name Qualifier
 if ($tempClaim->{renderingProvider}->getTaxId() ne '')
 {
...
# VALIDATIONS FOR FA@
#******************************************************************************************
	$self->checkValidValues(CONTAINS,CHECK_CHARACTERS,'','',$tempClaim->{renderingProvider}->getTaxId(),$tempClaim, 'FA@:Rendering Provider FederalTaxId must be numeric'   ,(0..9,'')); # federal tax id
