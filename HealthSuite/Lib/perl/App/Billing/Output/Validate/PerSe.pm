##############################################################################
package App::Billing::Output::Validate::PerSe;
##############################################################################
...
#*******************************************************************************************	
	...
	#$self->isRequired($refClaimCareReceiver->getFirstName(),$tempClaim,'CA0:Patient First Name');
	...
	# patient address 1  patient address 2 patient city  patient state patient zip code
		...
		#patient zip code
		$self->checkValidValues(NOT_CONTAINS,CHECK_CHARACTERS,$refClaimCareReceiverAddress->getZipCode(),$tempClaim,'CA0:Patient Zip Code',('-'));
