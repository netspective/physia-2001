...
use constant ADJUSTMENTTYPE_MANUAL => 1;
...
use constant ADJUSTWRITEOFF_REFUND => 1;
use constant ADJUSTWRITEOFF_CREDIT => 2;
use constant ADJUSTWRITEOFF_PROFCOURTESY => 3;
use constant ADJUSTWRITEOFF_BADDEBT => 4;
use constant ADJUSTWRITEOFF_COLLECTAGENCY => 5;
use constant ADJUSTWRITEOFF_CHARITYDISCOUNT => 6;
use constant ADJUSTWRITEOFF_PASTFILEDEADLINE => 7;
use constant ADJUSTWRITEOFF_POSTINGERROR => 8;
use constant ADJUSTWRITEOFF_NONBILLSERVICE => 9;
use constant ADJUSTWRITEOFF_RETURNEDCHECK => 10;
use constant ADJUSTWRITEOFF_NSFFEE => 11;
use constant ADJUSTWRITEOFF_CONTRACTAGREEMENT => 12;
...
use constant MARITALSTATUS_LEGALLYSEPARATED => 3;
use constant MARITALSTATUS_DIVORCED => 4;
use constant MARITALSTATUS_WIDOWED => 5;
use constant MARITALSTATUS_NOTAPPLICABLE => 6;
