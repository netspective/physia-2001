...
public class MainField extends IDField
{
	public MainField()
	{
		super();
	...
	public MainField(String aName, String aCaption)
	{
	...
	public boolean isValid(DialogContext dc)
	{
		...
		if (status && !(orgID.equalsIgnoreCase(""))) {
			...
			if (!status) {
				String invalidateMsg = idTextField.getCaption(dc) + " " + orgID + "does not exist.";
